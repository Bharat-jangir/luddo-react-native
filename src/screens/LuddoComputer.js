...
import { selectDiceTouch, selectIsComputer, selectPlayer1, selectPlayer2, selectPlayer3, selectPlayer4 } from '../redux/reducers/gameSelectors'
    ...
    <Wrapper>
        ...
        <View style={styles.container}>
            <View style={styles.flexRow} pointerEvents={isDiceTouch?'none':'auto'}>
                <Dice color={Colors.green} player={2} data={player2} isComputer={!isComputer}/>
                <Dice color={Colors.yellow} rotate player={3} data={player3} isComputer={isComputer}/>
            </View>
            <View style={styles.luddoBoard}>
                <View style={styles.plotContainer}>
                    <Pocket color={Colors.green} player={2} data={player2} isComputer={!isComputer}/>
                    <VerticalPath color={Colors.yellow} cells={Plot2Data}/>
                    <Pocket color={Colors.yellow} player={3} data={player3} isComputer={isComputer}/>
                ...
                <View style={styles.plotContainer}>
                    <Pocket color={Colors.red} player={1} data={player1} isComputer={isComputer}/>
                    <VerticalPath color={Colors.red} cells={Plot4Data}/>
                    <Pocket color={Colors.blue} player={4} data={player4} isComputer={!isComputer}/>

                </View>
            </View>
            <View style={styles.flexRow} pointerEvents={isDiceTouch?'none':'auto'} >
                <Dice color={Colors.red} player={1} data={player1} isComputer={isComputer}/>
                <Dice color={Colors.blue} rotate player={4} data={player4} isComputer={!isComputer}/>
            </View>
        </View>
